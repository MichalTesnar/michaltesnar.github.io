...
I quickly went on to read on the book and it turns out: there is scientific evidence that curiosity (rather than fixed goals) leads to remarkable discoveries! One can think of finding a solution to a problem as solving a maze. However, for most mazes marching directly towards the exit will only lead you to so many walls. Conversely, looking for new paths in a maze can instead lead you to the exit, even if that is not your primary goal. A beautiful case of this in real life is the solution of a combinatorics puzzle proposed by [an anonymous user on 4chan](https://www.wired.com/story/how-an-anonymous-4chan-post-helped-solve-a-25-year-old-math-puzzle/).
...
Anyways, I set myself the goal of being more creative and more explorative. Pay more attention to new ideas, and to not be scared to step aside from the daily rush and ponder them. But maybe that is exactly what I should not be doing: _the true way of achieving something seems to be letting it go_.