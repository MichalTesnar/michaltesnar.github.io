...
{% include figure.liquid loading="eager" path="assets/img/blog/jungfraujoch-avalanche.jpg" class="img-fluid rounded z-depth-1" width="500" height="300" %}

On the top we have enjoyed the views, and relaxed for a bit!

{% include figure.liquid loading="eager" path="assets/img/blog/jungfraujoch-group.jpeg" class="img-fluid rounded z-depth-1" width="500" height="300" %}

And we fed the birds that go all the way up there, just to be fed by the tourists.
{% include figure.liquid loading="eager" path="assets/img/blog/jungfraujoch-birds.jpg" class="img-fluid rounded z-depth-1" width="500" height="300" %}
