...
These courses will help you obtain sufficient mathematical dexterity (credits to Andrei Girjoaba for this naming) to read mathematical texts and understand the ideas behind them.
...
- __Linear Algebra I__: Essential for understanding spectral decomposition and the idea of subspaces. This is needed for understanding dimensionality reduction techniques like PCA, which are at the core of machine learning. As a plus, this course is introductory and it teaches proof techniques such as proof by contradiction, which is useful if you haven't done that in the past.
- __Linear Algebra II__: Essential for understanding singular value decomposition, which is also one of the essential mathematical tools. The latest example of usage is in understanding vanishing and exploding gradients phenomena of RNNs.
- __Calculus II__: Gradient is one of the main topics. This will be your best friend if you ever want to train a neural net. Hand in hand with it goes chain rule. If you do not trust me it is important, try to explain backpropagation without it. (You might want to take __Calculus I__ before if you do not trust yourself too much with your math skills, I have not done it myself and managed, but honestly I still struggle a bit with things like Fourier Series that are treated there)
- __Probability Theory__: Expectation, variance, probability distribution. Trust me, this is a must. The notions are not that difficult once profoundly understood, but this hard course is definitely worth the pain. Highly recommended.
- __Statistics__: ML is just Stats on steroids. Estimators play the main role in this course. The word likelihood finally started making sense to me in this course too. Finally, you also get insight into p-values and confidence intervals. Priceless.
- (Editor's Pick) __Analysis__: Alef Sterk is one of the best lecturers that I have encountered so far, and even though this course does not directly contribute to ML understanding I still recommend it cause it gives you a stronger basis. You get better at proving and in mathematical thinking.
...
- __Metric and Topological Spaces__: Reinforcement Learning needs this. Without fixed point theorem, how does the fact that Bellman operator is a contraction help you? (Didn't take this one).
- __Multivariable Analysis__: Keyword *Manifold*, these mythical mathematical objects pop up in learning theory from time to time. Maybe it is a stretch, but could also come in handy (didn't take this one).
...
And no, these courses will neither teach you that you should normalize your input when training a neural net nor explain what torch dataloader is. But I heard ChatGPT kinda slays that anyway :)

Anyway, let me know if this was helpful and if you have courses that you would like to add to the list or if you completely disagree with my perspective.